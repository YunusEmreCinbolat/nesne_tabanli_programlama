...
public class Students extends Person{
    ...
    public String toString() {
        return "Ögrenci " +"Ad: "+super.getName()+"   "+"TC: "+super.getTC()+"  Telefon numarasi: "+super.getPhone()+
                "  Dogum tarihi: "+super.getDogumtarihi()+"  Mail: "+super.getE_mail()+"  Kan Grubu: "+super.getBlood_group()+"  Adres: "+super.getAdress() +" Velinin Adı Soyadı: " + veliadsoyad + "  Velinin telefonu:" 
                        + velitelefon + "  Oda No:" + odano + "  Blok No: " + blokid ;
    }
